...
public class FrmUsuario_formulario extends javax.swing.JInternalFrame {
    ...
    private usuario_formulario entidad = new usuario_formulario();
    private BO_usuario_formulario BO = new BO_usuario_formulario();
    private DAO_usuario_formulario DAO = new DAO_usuario_formulario();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor= new cla_color_palete();
    private void abrir_formulario() {
        this.setTitle("USUARIO FORMULARIO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAO.actualizar_tabla_usuario_formulario(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_usuario_formulario(entidad, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            entidad.setC1idusuario_formulario(Integer.parseInt(txtid.getText()));
            entidad.setC2nombre(txtnombre.getText());
            BO.update_usuario_formulario(entidad, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbltabla);
        DAO.cargar_usuario_formulario(conn,entidad, idproducto);
        txtid.setText(String.valueOf(entidad.getC1idusuario_formulario()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAO.ancho_tabla_usuario_formulario(tbltabla);
