...
public class FrmGasto extends javax.swing.JInternalFrame {
    ...
    private BO_gasto BO = new BO_gasto();
    ...
    private void cargar_dato_caja_detalle() {
        ...
        ENTcaja.setC8monto_gasto(monto_gasto);
        ENTcaja.setC12fk_idgasto(idgasto);
        ENTcaja.setC10fk_idusuario(ENTusu.getGlobal_idusuario());
    }

    private void cargar_dato() {
        ENTg.setC3creado_por(creado_por);
        ENTg.setC4fecha(txtfecha.getText());
        ENTg.setC5descripcion(txtadescripcion.getText());
        monto_gasto = Double.parseDouble(txtmonto_gasto.getText());
        ENTg.setC6monto_gasto(monto_gasto);
        ENTg.setC7estado(estado_EMITIDO);
        ENTg.setC8fk_idgasto_tipo(getFk_idgasto_tipo());
        ENTg.setC9fk_idusuario(ENTusu.getGlobal_idusuario());
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_gasto(ENTg,ENTcaja);
            reestableser();
        }
    }
    ...
    private void seleccionar_tabla() {
        ...
        txtadescripcion.setText(ENTg.getC5descripcion());
        txtmonto_gasto.setText(String.valueOf((int) ENTg.getC6monto_gasto()));
        DAOgt.cargar_gasto_tipo(conn, ENTgt, ENTg.getC8fk_idgasto_tipo());
        txtbuscar_gasto_tipo.setText(ENTgt.getC2nombre());
