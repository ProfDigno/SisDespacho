 ...
 * @author Digno
 */
public class FrmTipo_institucion extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private tipo_institucion entidad = new tipo_institucion();
    private BO_tipo_institucion BO = new BO_tipo_institucion();
    private DAO_tipo_institucion DAO = new DAO_tipo_institucion();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor= new cla_color_palete();
    private void abrir_formulario() {
        this.setTitle("TIPO INSTITUCION");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAO.actualizar_tabla_tipo_institucion(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_tipo_institucion(entidad, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            entidad.setC1idtipo_institucion(Integer.parseInt(txtid.getText()));
            entidad.setC2nombre(txtnombre.getText());
            BO.update_tipo_institucion(entidad, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbltabla);
        DAO.cargar_tipo_institucion(conn,entidad, idproducto);
        txtid.setText(String.valueOf(entidad.getC1idtipo_institucion()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAO.ancho_tabla_tipo_institucion(tbltabla);
