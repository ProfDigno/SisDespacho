 ...
 * @author Digno
 */
public class FrmMoneda_cambio extends javax.swing.JInternalFrame {
    ...
    private boolean validar_guardar() {
        if (evejtf.getBoo_JTextField_vacio(txtmoneda, "DEBE CARGAR UN NOMBRE MONEDA")) {
            return false;
        }
        if (evejtf.getBoo_JTextField_vacio(txtguarani_unidad_aduana, "DEBE CARGAR UNA MONTO DE UNO POR GUARANI DE ADUANA")) {
            return false;
        }
        if (evejtf.getBoo_JTextField_vacio(txtguarani_unidad_mercado, "DEBE CARGAR UNA MONTO DE UNO POR GUARANI DEL MERCADO")) {
            return false;
        }
    ...
    private void reestableser(){
        ...
        txtguarani_unidad_aduana.setText(null);
        txtguarani_unidad_mercado.setText(null);
    ...
    private void initComponents() {
        ...
        txtguarani_unidad_aduana = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        txtsigla = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        txtguarani_unidad_mercado = new javax.swing.JTextField();
        ...
        txtguarani_unidad_aduana.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtguarani_unidad_aduana.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtguarani_unidad_aduanaKeyPressed(evt);
            }
        });
        ...
        jLabel5.setText("Guarani Mercado:");

        txtguarani_unidad_mercado.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtguarani_unidad_mercado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtguarani_unidad_mercadoKeyPressed(evt);
            }
        });
        ...
        panel_insertarLayout.setHorizontalGroup(
            ...
            .addGroup(panel_insertarLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txtmoneda, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtsigla, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addComponent(txtguarani_unidad_mercado, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtguarani_unidad_aduana, javax.swing.GroupLayout.Alignment.LEADING)))
        ...
        panel_insertarLayout.setVerticalGroup(
            ...
            .addGroup(panel_insertarLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtguarani_unidad_aduana, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5)
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtguarani_unidad_mercado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtguarani_unidad_aduanaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtguarani_unidad_aduanaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtguarani_unidad_aduanaKeyPressed
    ...
    private javax.swing.JTextField txtguarani_unidad_aduana;
    private javax.swing.JTextField txtguarani_unidad_mercado;
