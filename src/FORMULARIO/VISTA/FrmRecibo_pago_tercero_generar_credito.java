...
public class FrmRecibo_pago_tercero_generar_credito extends javax.swing.JInternalFrame {
    ...
    private BO_tercero clBO = new BO_tercero();
    ...
    private DAO_tercero cdao = new DAO_tercero();
    private tercero clie = new tercero();
...
//            rpcli_bo.update_recibo_pago_finanza(rpcli, tblpro_categoria);
    ...
    private void cargar_cliente() {
        cdao.cargar_tercero(conn, clie, clie.getC1idtercero_global());
        cargar_cliente_local(clie);
    }

    private void cargar_cliente_local(tercero cli) {
        fk_idcliente = cli.getC1idtercero();
        txtcli_nombre.setText(cli.getC4nombre());
        txtcli_ruc.setText(cli.getC5ruc());
        txtcli_direccion.setText(cli.getC7direccion());
        txtcli_telefono.setText(cli.getC6telefono());
        jFcli_saldo_credito.setValue(cli.getC17saldo_credito());
