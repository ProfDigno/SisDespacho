 ...
 * @author Digno
 */
public class FrmTipo_dependencia extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private tipo_dependencia entidad = new tipo_dependencia();
    private BO_tipo_dependencia BO = new BO_tipo_dependencia();
    private DAO_tipo_dependencia DAO = new DAO_tipo_dependencia();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor= new cla_color_palete();
    private void abrir_formulario() {
        this.setTitle("TIPO DEPENDENCIA");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAO.actualizar_tabla_tipo_dependencia(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_tipo_dependencia(entidad, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            entidad.setC1idtipo_dependencia(Integer.parseInt(txtid.getText()));
            entidad.setC2nombre(txtnombre.getText());
            BO.update_tipo_dependencia(entidad, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbltabla);
        DAO.cargar_tipo_dependencia(conn,entidad, idproducto);
        txtid.setText(String.valueOf(entidad.getC1idtipo_dependencia()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAO.ancho_tabla_tipo_dependencia(tbltabla);
