 ...
 * @author Digno
 */
public class FrmTipo_Registro extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private tipo_registro entidad = new tipo_registro();
    private BO_tipo_registro BO = new BO_tipo_registro();
    private DAO_tipo_registro DAO = new DAO_tipo_registro();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor= new cla_color_palete();
    private void abrir_formulario() {
        this.setTitle("TIPO REGISTRO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAO.actualizar_tabla_tipo_registro(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_tipo_registro(entidad, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            entidad.setC1idtipo_registro(Integer.parseInt(txtid.getText()));
            entidad.setC2nombre(txtnombre.getText());
            BO.update_tipo_registro(entidad, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbltabla);
        DAO.cargar_tipo_registro(conn,entidad, idproducto);
        txtid.setText(String.valueOf(entidad.getC1idtipo_registro()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAO.ancho_tabla_tipo_registro(tbltabla);
