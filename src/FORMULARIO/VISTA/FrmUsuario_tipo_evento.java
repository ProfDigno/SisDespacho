...
public class FrmUsuario_tipo_evento extends javax.swing.JInternalFrame {
    ...
    private usuario_tipo_evento entidad = new usuario_tipo_evento();
    private BO_usuario_tipo_evento BO = new BO_usuario_tipo_evento();
    private DAO_usuario_tipo_evento DAO = new DAO_usuario_tipo_evento();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor= new cla_color_palete();
    private void abrir_formulario() {
        this.setTitle("USUARIO TIPO EVENTO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAO.actualizar_tabla_usuario_tipo_evento(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            BO.insertar_usuario_tipo_evento(entidad, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            entidad.setC1idusuario_tipo_evento(Integer.parseInt(txtid.getText()));
            entidad.setC2nombre(txtnombre.getText());
            BO.update_usuario_tipo_evento(entidad, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbltabla);
        DAO.cargar_usuario_tipo_evento(conn,entidad, idproducto);
        txtid.setText(String.valueOf(entidad.getC1idusuario_tipo_evento()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAO.ancho_tabla_usuario_tipo_evento(tbltabla);
