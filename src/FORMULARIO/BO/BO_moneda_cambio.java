...
private DAO_moneda_cambio mcam_dao = new DAO_moneda_cambio();
	...
	public void update_moneda_cambio(moneda_cambio mcam, JTable tbltabla) {
		if (evmen.MensajeGeneral_warning("ESTAS SEGURO DE MODIFICAR MONEDA_CAMBIO", "MODIFICAR", "ACEPTAR", "CANCELAR")) {
