...
private DAO_despacho_zona dzon_dao = new DAO_despacho_zona();
	...
	public void update_despacho_zona(despacho_zona dzon, JTable tbltabla) {
		if (evmen.MensajeGeneral_warning("ESTAS SEGURO DE MODIFICAR DESPACHO_ZONA", "MODIFICAR", "ACEPTAR", "CANCELAR")) {
