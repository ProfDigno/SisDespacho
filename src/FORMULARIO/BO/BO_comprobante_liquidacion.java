...
public class BO_comprobante_liquidacion {
    ...
    public void update_comprobante_liquidacion(comprobante_liquidacion coliq, JTable tbltabla,boolean es_editar) {
        String mensaje = "";
        String titulo1 = "";
        String btnok = "";
        if (es_editar) {
            mensaje = "ESTAS SEGURO DE MODIFICAR COMPROBANTE_LIQUIDACION";
            titulo1 = "MODIFICAR";
            btnok = "ACEPTAR";
        }else{
            mensaje = "ESTAS SEGURO DE ELIMINAR COMPROBANTE_LIQUIDACION";
            titulo1 = "ELIMINAR";
            btnok = "ELIMINAR";
        }
