...
private DAO_honorario_despacho hdes_dao = new DAO_honorario_despacho();
	...
	public void update_honorario_despacho(honorario_despacho hdes, JTable tbltabla) {
		if (evmen.MensajeGeneral_warning("ESTAS SEGURO DE MODIFICAR HONORARIO_DESPACHO", "MODIFICAR", "ACEPTAR", "CANCELAR")) {
