...
public class BO_tercero_pais {
    ...
    public void update_tercero_pais_eliminar(tercero_pais tepa, JTable tbltabla) {
        if (evmen.MensajeGeneral_warning("ESTAS SEGURO DE ELIMINAR TERCERO PAIS", "ELIMINAR", "ACEPTAR", "CANCELAR")) {
            ...
            try {
                ...
                tepa_dao.update_tercero_pais_eliminar(conn, tepa);
                tepa_dao.actualizar_tabla_tercero_pais(conn, tbltabla);
                conn.commit();
            } catch (SQLException e) {
                evmen.mensaje_error(e, tepa.toString(), titulo);
