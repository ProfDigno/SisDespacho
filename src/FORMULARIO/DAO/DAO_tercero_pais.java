...
public class DAO_tercero_pais {
    ...
    private String sql_insert = "INSERT INTO tercero_pais(idtercero_pais,nombre,sigla,eliminado) VALUES (?,?,?,?);";
    private String sql_update = "UPDATE tercero_pais SET nombre=?,sigla=? WHERE idtercero_pais=?;";
    private String sql_select = "SELECT idtercero_pais as idp,nombre as pais,sigla FROM tercero_pais where eliminado=false order by 1 desc;";
    private String sql_cargar = "SELECT idtercero_pais,nombre,sigla FROM tercero_pais WHERE idtercero_pais=";
    private String sql_update_eliminar = "UPDATE tercero_pais SET eliminado=true WHERE idtercero_pais=?;"; 
    public void insertar_tercero_pais(Connection conn, tercero_pais tepa) {
        ...
        try {
            ...
            pst.setBoolean(4, tepa.isC4eliminado());
            pst.execute();
            pst.close();
    ...
    public void update_tercero_pais_eliminar(Connection conn, tercero_pais tepa) {
        String titulo = "update_tercero_pais_eliminar";
        PreparedStatement pst = null;
        try {
