...
public class DAO_saldo_credito_cliente {
    ...
    private String sql_insert = "INSERT INTO saldo_credito_tercero(idsaldo_credito_tercero,fecha_emision,descripcion,monto_saldo_credito,monto_letra,estado,fk_idtercero,fk_idusuario) VALUES (?,?,?,?,?,?,?,?);";
    private String sql_update = "UPDATE saldo_credito_tercero SET fecha_emision=?,descripcion=?,monto_saldo_credito=?,monto_letra=?,estado=?,fk_idtercero=?,fk_idusuario=? WHERE idsaldo_credito_tercero=?;";
    private String sql_select = "SELECT idsaldo_credito_tercero,fecha_emision,descripcion,monto_saldo_credito,monto_letra,estado,fk_idtercero,fk_idusuario FROM saldo_credito_tercero order by 1 desc;";
    private String sql_cargar = "SELECT idsaldo_credito_tercero,fecha_emision,descripcion,monto_saldo_credito,monto_letra,estado,fk_idtercero,fk_idusuario FROM saldo_credito_tercero WHERE idsaldo_credito_tercero=";
    ...
    public void insertar_saldo_credito_cliente(Connection conn, saldo_credito_cliente sccl) {
        ...
        String titulo = "insertar_saldo_credito_tercero";
    ...
    public void update_saldo_credito_cliente(Connection conn, saldo_credito_cliente sccl) {
        String titulo = "update_saldo_credito_tercero";
        PreparedStatement pst = null;
        try {
