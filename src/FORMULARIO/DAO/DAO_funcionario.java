...
public class DAO_funcionario {
	...
	private String sql_select = "SELECT idfuncionario,fecha_creado,creado_por,nombre,cedula,telefono,direccion,cargo,salario FROM funcionario order by 1 desc;";
