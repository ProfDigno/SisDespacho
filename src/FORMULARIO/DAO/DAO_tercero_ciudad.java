...
public class DAO_tercero_ciudad {
    ...
    private String sql_insert = "INSERT INTO tercero_ciudad(idtercero_ciudad,nombre,sigla) VALUES (?,?,?);";
    private String sql_update = "UPDATE tercero_ciudad SET nombre=?,sigla=? WHERE idtercero_ciudad=?;";
    private String sql_select = "SELECT idtercero_ciudad as idc,nombre,sigla FROM tercero_ciudad order by 1 desc;";
