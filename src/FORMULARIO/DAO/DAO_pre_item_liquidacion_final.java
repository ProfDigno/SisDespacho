...
public class DAO_pre_item_liquidacion_final {
    ...
    private String sql_insert = "INSERT INTO pre_item_liquidacion_final(idpre_item_liquidacion_final,orden,fk_idcomprobante_liquidacion,eliminado) VALUES (?,?,?,?);";
    private String sql_update = "UPDATE pre_item_liquidacion_final SET orden=?,fk_idcomprobante_liquidacion=?,eliminado=? WHERE idpre_item_liquidacion_final=?;";
    ...
    public void insertar_pre_item_liquidacion_final(Connection conn, pre_item_liquidacion_final pilf) {
        ...
        try {
            ...
            pst.setBoolean(4, pilf.getC4eliminado());
            pst.execute();
            pst.close();
    ...
    public void update_pre_item_liquidacion_final(Connection conn, pre_item_liquidacion_final pilf) {
        ...
        try {
            ...
            pst.setBoolean(3, pilf.getC4eliminado());
            pst.setInt(4, pilf.getC1idpre_item_liquidacion_final());
            pst.execute();
            pst.close();
